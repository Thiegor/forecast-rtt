      ...
      <div style={{width:480,background:RTT.cinzaEscuro,borderLeft:`1px solid ${RTT.cinzaBorda2}`,display:"flex",flexDirection:"column",overflow:"hidden"}}>
        <div style={{background:RTT.vermelho,padding:"22px 24px 18px"}}>
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8}}>
            {[
              {l:"Total BP 2026", v:`R$ ${fmt(totalBP)}`, c:"rgba(255,255,255,0.9)"},
              {l:"BP Médio/mês", v:`R$ ${fmt(totalBP/12)}`, c:"rgba(255,255,255,0.9)"},
            ].map(k=>(
          ...
          <div style={{display:"flex",alignItems:"center",gap:20}}>
            ...
            <div style={{display:"flex",gap:20}}>
              {[
                ...
                {l:"Δ vs BP", v:delta!==null?(delta>0?"+":"")+delta.toFixed(0)+"%":"—", c:delta>=0?RTT.verde:RTT.vermelho},
              ].map(k=>(
                <div key={k.l}>
          ...
          <>
              ...
              return (
                <div key={gerente} style={{marginBottom:16}}>
                  ...
                  {projs.map(proj => {
                    ...
                    return (
                      <div key={proj.chave_rfc} style={{display:"grid",gridTemplateColumns:"280px 1fr 1fr 1fr 36px",gap:4,alignItems:"center",padding:"8px 12px",borderRadius:6,marginBottom:2,background:RTT.cinzaEscuro,border:`1px solid ${RTT.cinzaBorda}`}}>
                        ...
                        <button onClick={()=>setPainel(proj)} style={{width:28,height:28,background:"transparent",border:`1px solid ${RTT.cinzaBorda}`,borderRadius:5,color:RTT.cinzaTexto,cursor:"pointer",fontSize:16,display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0}}
            ...
            <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"12px 16px",marginTop:8,background:RTT.cinzaEscuro,borderRadius:7,border:`1px solid ${RTT.cinzaBorda}`}}>
              ...
              <button onClick={handleEnviar} disabled={enviando} style={{background:RTT.vermelho,color:"#fff",border:"none",padding:"9px 22px",borderRadius:6,fontSize:12,fontWeight:700,cursor:"pointer",fontFamily:"inherit",letterSpacing:"0.05em",opacity:enviando?0.7:1}}
                onMouseEnter={e=>{if(!enviando)e.currentTarget.style.background=RTT.vermelhoEscuro}}
